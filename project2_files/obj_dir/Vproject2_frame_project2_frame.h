...
VL_MODULE(Vproject2_frame_project2_frame) {
  public:
    ...
    CData/*0:0*/ __PVT__my_DE_stage__DOT__is_type_I_AGEX_Valid;
    CData/*0:0*/ __PVT__my_DE_stage__DOT__is_type_I_MEM_Valid;
    CData/*0:0*/ __PVT__my_DE_stage__DOT__is_type_I_WB_Valid;
    ...
    SData/*11:0*/ __PVT__from_FE_to_AGEX;
    ...
    VlWide<6>/*177:0*/ __PVT__my_FE_stage__DOT__FE_latch;
    ...
    IData/*31:0*/ __PVT__my_FE_stage__DOT__guessed_br_address;
    VlWide<10>/*289:0*/ __PVT__my_DE_stage__DOT__DE_latch;
    IData/*31:0*/ __PVT__my_DE_stage__DOT__sxt_imm_DE;
    VlWide<6>/*180:0*/ __PVT__my_AGEX_stage__DOT__AGEX_latch;
    IData/*31:0*/ __PVT__my_AGEX_stage__DOT__hit_prediction_AGEX;
    IData/*31:0*/ __PVT__my_AGEX_stage__DOT__branch_count_AGEX;
    IData/*31:0*/ __PVT__my_AGEX_stage__DOT__actual_branch_address_AGEX;
    ...
    VlWide<6>/*177:0*/ __Vdly__my_FE_stage__DOT__FE_latch;
    ...
    VlUnpacked<CData/*1:0*/, 256> __PVT__my_AGEX_stage__DOT__pt_AGEX;
    VlUnpacked<IData/*25:0*/, 16> __PVT__my_AGEX_stage__DOT__btb_tag_AGEX;
    VlUnpacked<IData/*31:0*/, 16> __PVT__my_AGEX_stage__DOT__btb_value_AGEX;
