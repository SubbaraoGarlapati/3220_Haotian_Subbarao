; ModuleID = 'C:/Users/Cody/Documents/cs3220/3220_Haotian_Subbarao/project5_files/project5_hls_opt/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_example_ir(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"* %A, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"* %B) local_unnamed_addr #0 {
entry:
  ...
  call fastcc void @copy_out(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"* %A, i32* %A_copy.data, i4* %A_copy.keep, i4* %A_copy.strb, i2* %A_copy.user, i1* %A_copy.last, i5* %A_copy.id, i6* %A_copy.dest, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6>, 0>"* %B, i32* %B_copy.data, i4* %B_copy.keep, i4* %B_copy.strb, i2* %B_copy.user, i1* %B_copy.last, i5* %B_copy.id, i6* %B_copy.dest)
  ret void
}
