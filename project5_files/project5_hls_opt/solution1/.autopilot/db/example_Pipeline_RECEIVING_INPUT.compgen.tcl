...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { A_TVALID { I 1 bit } A_TDATA { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { local_in_buffer_address0 { O 14 vector } local_in_buffer_ce0 { O 1 bit } local_in_buffer_we0 { O 1 bit } local_in_buffer_d0 { O 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ii_out \
    op interface \
    ports { ii_out { O 32 vector } ii_out_ap_vld { O 1 bit } } \
} "
}
