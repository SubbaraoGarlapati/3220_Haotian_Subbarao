set moduleName example_Pipeline_KENEL_INIT
set isTopModule 0
...
set C_modelName {example_Pipeline_KENEL_INIT}
...
set portList { 
	...
	{ kernel_address0 sc_out sc_lv 4 signal 0 } 
	{ kernel_ce0 sc_out sc_logic 1 signal 0 } 
	{ kernel_we0 sc_out sc_logic 1 signal 0 } 
	{ kernel_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
