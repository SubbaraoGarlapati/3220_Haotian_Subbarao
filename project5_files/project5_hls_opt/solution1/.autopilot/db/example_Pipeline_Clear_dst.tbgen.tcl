set moduleName example_Pipeline_Clear_dst
set isTopModule 0
...
set C_modelName {example_Pipeline_Clear_dst}
set C_modelType { void 0 }
set C_modelArgList {
	{ local_out_buffer int 32 regular {array 16000 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ local_out_buffer_we0 sc_out sc_logic 1 signal 0 } 
	{ local_out_buffer_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	local_out_buffer { ap_memory {  { local_out_buffer_address0 mem_address 1 14 }  { local_out_buffer_ce0 mem_ce 1 1 }  { local_out_buffer_we0 mem_we 1 1 }  { local_out_buffer_d0 mem_din 1 32 } } }
}
