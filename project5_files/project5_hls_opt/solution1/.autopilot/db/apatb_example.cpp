...
((hls::stream<int>*)__xlx_apatb_param_A_V_data_V)->read();
...
B_V_strb_V_pc_buffer_Copy=B_V_strb_V_pc_buffer;
          ...
          std::vector<sc_bv<32> > B_V_user_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > B_V_user_V_pc_buffer;
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
...
B_V_last_V_pc_buffer_Copy=B_V_last_V_pc_buffer;
          ...
          std::vector<sc_bv<32> > B_V_id_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > B_V_id_V_pc_buffer;
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
...
B_V_id_V_pc_buffer_Copy=B_V_id_V_pc_buffer;
          ...
          std::vector<sc_bv<32> > B_V_dest_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > B_V_dest_V_pc_buffer;
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
...
((int*)&xlx_stream_elt_data)[0] = B_V_data_V_pc_buffer_Copy[j].to_int64();
((hls::stream<int>*)__xlx_apatb_param_B_V_data_V)->write(xlx_stream_elt_data);
...
// data
std::vector<int> __xlx_apatb_param_A_V_data_V_stream_buf;
{
  while (!((hls::stream<int>*)__xlx_apatb_param_A_V_data_V)->empty())
    __xlx_apatb_param_A_V_data_V_stream_buf.push_back(((hls::stream<int>*)__xlx_apatb_param_A_V_data_V)->read());
  for (int i = 0; i < __xlx_apatb_param_A_V_data_V_stream_buf.size(); ++i)
    ((hls::stream<int>*)__xlx_apatb_param_A_V_data_V)->write(__xlx_apatb_param_A_V_data_V_stream_buf[i]);
  }
long __xlx_apatb_param_A_stream_buf_size = ((hls::stream<int>*)__xlx_apatb_param_A_V_data_V)->size();
// keep
...
// data
std::vector<int> __xlx_apatb_param_B_V_data_V_stream_buf;
long __xlx_apatb_param_B_stream_buf_size = ((hls::stream<int>*)__xlx_apatb_param_B_V_data_V)->size();
// keep
...
long __xlx_apatb_param_A_stream_buf_final_size = __xlx_apatb_param_A_stream_buf_size - ((hls::stream<int>*)__xlx_apatb_param_A_V_data_V)->size();
...
sc_bv<32> __xlx_tmp_0_lv = ((int*)&__xlx_apatb_param_A_V_data_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_0_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVIN_A_V_data_V, __xlx_sprintf_buffer.data());
sc_bv<4> __xlx_tmp_1_lv = ((char*)&__xlx_apatb_param_A_V_keep_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_1_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVIN_A_V_keep_V, __xlx_sprintf_buffer.data());
sc_bv<4> __xlx_tmp_2_lv = ((char*)&__xlx_apatb_param_A_V_strb_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_2_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVIN_A_V_strb_V, __xlx_sprintf_buffer.data());
sc_bv<2> __xlx_tmp_3_lv = ((char*)&__xlx_apatb_param_A_V_user_V_stream_buf[j])[0];
...
sc_bv<5> __xlx_tmp_5_lv = ((char*)&__xlx_apatb_param_A_V_id_V_stream_buf[j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_5_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVIN_A_V_id_V, __xlx_sprintf_buffer.data());
sc_bv<6> __xlx_tmp_6_lv = ((char*)&__xlx_apatb_param_A_V_dest_V_stream_buf[j])[0];
...
long __xlx_apatb_param_B_stream_buf_final_size = ((hls::stream<int>*)__xlx_apatb_param_B_V_data_V)->size() - __xlx_apatb_param_B_stream_buf_size;
{
  while (!((hls::stream<int>*)__xlx_apatb_param_B_V_data_V)->empty())
    __xlx_apatb_param_B_V_data_V_stream_buf.push_back(((hls::stream<int>*)__xlx_apatb_param_B_V_data_V)->read());
  for (int i = 0; i < __xlx_apatb_param_B_V_data_V_stream_buf.size(); ++i)
    ((hls::stream<int>*)__xlx_apatb_param_B_V_data_V)->write(__xlx_apatb_param_B_V_data_V_stream_buf[i]);
  }
{
...
sc_bv<32> __xlx_tmp_0_lv = ((int*)&__xlx_apatb_param_B_V_data_V_stream_buf[__xlx_apatb_param_B_stream_buf_size+j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_0_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVOUT_B_V_data_V, __xlx_sprintf_buffer.data());
sc_bv<4> __xlx_tmp_1_lv = ((char*)&__xlx_apatb_param_B_V_keep_V_stream_buf[__xlx_apatb_param_B_stream_buf_size+j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_1_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVOUT_B_V_keep_V, __xlx_sprintf_buffer.data());
sc_bv<4> __xlx_tmp_2_lv = ((char*)&__xlx_apatb_param_B_V_strb_V_stream_buf[__xlx_apatb_param_B_stream_buf_size+j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_2_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVOUT_B_V_strb_V, __xlx_sprintf_buffer.data());
sc_bv<2> __xlx_tmp_3_lv = ((char*)&__xlx_apatb_param_B_V_user_V_stream_buf[__xlx_apatb_param_B_stream_buf_size+j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_3_lv.to_string(SC_HEX).c_str());
...
sc_bv<5> __xlx_tmp_5_lv = ((char*)&__xlx_apatb_param_B_V_id_V_stream_buf[__xlx_apatb_param_B_stream_buf_size+j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_5_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVOUT_B_V_id_V, __xlx_sprintf_buffer.data());
sc_bv<6> __xlx_tmp_6_lv = ((char*)&__xlx_apatb_param_B_V_dest_V_stream_buf[__xlx_apatb_param_B_stream_buf_size+j])[0];
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_6_lv.to_string(SC_HEX).c_str());
