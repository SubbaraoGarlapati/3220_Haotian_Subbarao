...
=======
    ...
    if ((1U & (IData)((vlSelf->__PVT__from_FE_to_AGEX 
                       >> 0x2dU)))) {
        if ((((1U & (IData)((vlSelf->__PVT__from_FE_to_AGEX 
                             >> 0x2cU))) == (IData)(vlSelf->__PVT__my_AGEX_stage__DOT__actual_br_direction)) 
             & ((IData)((vlSelf->__PVT__from_FE_to_AGEX 
                         >> 0xcU)) == vlSelf->__PVT__my_AGEX_stage__DOT__newpc_AGEX))) {
            __Vdly__my_AGEX_stage__DOT__hit_prediction_AGEX 
    ...
    if (vlSymsp->TOP.reset) {
        ...
        __Vdly__my_FE_stage__DOT__inst_count_FE = ((IData)(vlSelf->__PVT__my_FE_stage__DOT__is_BTB_hit_FE)
                                                    ? 
                                                   ((IData)(1U) 
                                                    + vlSelf->__PVT__my_FE_stage__DOT__inst_count_FE)
                                                    : 
...
VL_INLINE_OPT void Vproject2_frame_project2_frame___sequent__TOP__project2_frame__8(Vproject2_frame_project2_frame* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vproject2_frame__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vproject2_frame_project2_frame___sequent__TOP__project2_frame__8\n"); );
    // Init
    CData/*5:0*/ __Vtableidx1;
<<<<<<< Updated upstream
    VlWide<8>/*255:0*/ __Vtemp_hc8e684d1__0;
    // Body
=======
    ...
    if ((1U & (((IData)(vlSelf->__PVT__my_DE_stage__DOT__pipeline_stall_DE) 
               ...
               | (0U == ((vlSelf->__PVT__my_FE_stage__DOT__FE_latch[4U] 
                          << 0x1cU) | (vlSelf->__PVT__my_FE_stage__DOT__FE_latch[3U] 
                                       >> 4U)))))) {
        __Vtemp_hc8e684d1__0[0U] = Vproject2_frame__ConstPool__CONST_h4737c94f_0[0U];
        __Vtemp_hc8e684d1__0[3U] = Vproject2_frame__ConstPool__CONST_h4737c94f_0[3U];
    } else {
        __Vtemp_hc8e684d1__0[0U] = ((vlSelf->__PVT__my_DE_stage__DOT__sxt_imm_DE 
                                     << 0xeU) | ((0x3e00U 
                                                  & (vlSelf->__PVT__my_FE_stage__DOT__FE_latch[3U] 
                                                     >> 2U)) 
                                                 | ((((((((((0xcU 
                                                    ...
                                                    | (((IData)(vlSelf->__PVT__my_DE_stage__DOT__type_I_DE) 
                                                       ...
                                                       | (0xfU 
                                                          & vlSelf->__PVT__my_FE_stage__DOT__FE_latch[0U])))));
        __Vtemp_hc8e684d1__0[3U] = (((IData)((((QData)((IData)(
=======
...
VL_INLINE_OPT void Vproject2_frame_project2_frame___combo__TOP__project2_frame__11(Vproject2_frame_project2_frame* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vproject2_frame__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vproject2_frame_project2_frame___combo__TOP__project2_frame__11\n"); );
    // Body
                                                    ...
                                                    ((0x20U 
                                                     ...
                                                     ((0x21U 
                                                      ...
                                                      | ((((vlSelf->__PVT__my_DE_stage__DOT__DE_latch[3U] 
                                                          ...
                                                          : 0U))))))));
    vlSelf->__PVT__my_AGEX_stage__DOT__br_cond_AGEX 
        = ((1U & (IData)((vlSelf->__PVT__from_FE_to_AGEX 
                          >> 0x2dU))) ? ((1U & (IData)(
